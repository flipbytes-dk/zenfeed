...
describe('Authentication Integration Tests', () => {
  ...
  describe('Complete Registration Flow', () => {
    it('should complete full registration flow: register → verify email → login', async () => {
      ...
      expect(registerData.message).toBe('Registration successful! Please check your email to verify your account.');
  ...
  describe('Complete Password Reset Flow', () => {
    ...
    it('should handle expired reset token', async () => {
      ...
      resetEntry.expires = new Date(Date.now() - 1000); // Expired 1 second ago
